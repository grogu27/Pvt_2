...
set output "all_to_one.png"
set title "all_to_one" font 'Calibri,18'
...
plot '../all_to_one_4node_4proc' using 1:2 title "node = 4 proc = 4" with linespoints lw 2 pt 7 lc rgb 'blue', \
