...
plot x title "Linear speedup" with linespoints  lw 2 pt 7 lc rgb 'red', \
     'graph/res_28000_speedup.txt' using 1:2 title "n = 28000, Memory used: 2990 MiB" with linespoints lw 2 pt 7 lc rgb 'black', \
     'graph/res_45000_speedup.txt' using 1:2 title "n = 45000, Memory used: 7725 MiB" with linespoints lw 2 pt 7 lc rgb 'green'
